class Game:
    ...
    def getMoves(self, pieceRow, pieceCol):
        ...
        for dir, cords in self.dirs.items():
            ...
            if newRow < 0 or newCol < 0 or newRow >= self.rows or newCol >= self.cols or self.newBoard[newRow][
                newCol] == " ":
                continue
